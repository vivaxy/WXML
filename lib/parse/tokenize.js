...
function tokenize(input, traverse) {
  ...
  ACTIONS.BRACE_LEFT = 150;
  ACTIONS.BRACE_RIGHT = 151;

  CHAR_TO_ACTIONS[CHAR.BRACE_LEFT] = ACTIONS.BRACE_LEFT;
  CHAR_TO_ACTIONS[CHAR.BRACE_RIGHT] = ACTIONS.BRACE_RIGHT;

  let mustache = false;

  function startMustache(char) {
  ...
  stateMachine[STATES.TEXT][ACTIONS.BRACE_LEFT] = startMustache;
  stateMachine[STATES.TEXT][ACTIONS.BRACE_RIGHT] = endMustache;
